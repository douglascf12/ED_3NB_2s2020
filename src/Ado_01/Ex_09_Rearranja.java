 ...
 * @version: 1.0
 * Main Class File: Ex_09_Rearranja.java
 * File: Ex_09_Rearranja.java
 * Date: 31/08/2020
 */
public class Ex_09_Rearranja {
    ...
    public static void main(String[] args) {
        ...
        rearranja(vetor); // reajando o vetor 
    ...
    public static void rearranja(int[] vetor) {
